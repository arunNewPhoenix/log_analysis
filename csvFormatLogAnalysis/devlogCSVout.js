...
// Read the log file
fs.readFile('../logData/api-dev-out.log', 'utf8', (err, data) => {
  if (err) {
  ...
  // Write to a CSV file
  fs.writeFile('api-dev-logs-summary.csv', csvContent, (err) => {
    if (err) {
      console.error('Error writing to CSV file:', err);
      return;
    }
    console.log('CSV file written successfully: api-dev-logs-summary.csv');
  });
});
